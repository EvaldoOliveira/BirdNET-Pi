...
## STATION_LAYER is the folder under custom/ whose model files (labels.txt, l18n/labels_*.json)
## are re-applied after every update - leave empty on a stock install
STATION_LAYER=
